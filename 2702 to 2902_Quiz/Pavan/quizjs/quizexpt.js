    ...
    if(n != null ) {
       ...
       result.push(document.getElementById(n).value); 
        ...
        if(random[count] <length){
            document.getElementById("qtn").innerHTML=myObject[random[count]].question;
		    document.getElementById("1").value=myObject[random[count]].options[0];
		    document.getElementById("2").value=myObject[random[count]].options[1];
		    document.getElementById("3").value=myObject[random[count]].options[2];
		    document.getElementById("4").value=myObject[random[count]].options[3];
            count++;
        }
         else{   
 ...
 function checkAnswers(){
     ...
     var wrongCount=0;
      for(var i=0;i<result.length;i++){
          if(result[i] === myObject[random[i]].answer){
              points +=20;
              correctCount++;
